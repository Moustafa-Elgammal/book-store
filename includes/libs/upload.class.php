...
class uploader_b {
	...
	public function Upload_File_Generate_Name() {
		$new_name = date ( 'y-m-d' ).'Basiet_elgammal_' . sha1 (  date ( "d-m-Y_g-i-s_u" ).rand ( '99999', '99999' ) . date ( 'y-m-d' ) . $this->up_file_name );
