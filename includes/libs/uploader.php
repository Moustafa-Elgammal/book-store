...
class uploader {
	...
	public function Upload_File_Generate_Name() {
		$new_name = sha1 ( 'Softmasr_' ) . date ( "d-m-Y_g-i-s_u" ) . md5 ( $this->up_file_name );
	...
	public function Upload_Get_File_Info() {
		...
		$info ['path'] = "templates/" . $this->up_dir . "/" . $this->up_file_new_name . "." . $this->up_ext;
		
		return $info;
	}
	public function name() {
		return $this->up_file_new_name;
	}
	function Mime($path) {
		$result = false;
